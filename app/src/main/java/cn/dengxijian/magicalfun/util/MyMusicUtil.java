...
/**
 * Created by dengxijian on 2019/2/8.
 */
...
public class MyMusicUtil {
    ...
    public static void setShared(String key, int value){
        SharedPreferences pref = MyApplication.getInstance().getSharedPreferences("music",MyApplication.getInstance().MODE_PRIVATE);
    ...
    public static void setBingShared(String value){
        SharedPreferences pref = MyApplication.getInstance().getSharedPreferences("bing_pic",MyApplication.getInstance().MODE_PRIVATE);
        SharedPreferences.Editor editor = pref.edit();
